...
As of this build: **208 unit tests** and **119 end-to-end tests** (see Known Limitations for which of the most recent additions have and haven't been reconfirmed passing in this specific environment).
...
3. **Full-text search ranking/snippets** in the Library (currently exact FTS5 match, no relevance snippet preview).
4. **True multi-window support.**
5. **Export/import of the whole library** (not just per-archive export), for migrating between machines.
6. **Accessibility pass** on the trusted UI (keyboard navigation, screen reader labeling).

...
As of this build: **210 unit tests** and **121 end-to-end tests** (see Known Limitations for which of the most recent additions have and haven't been reconfirmed passing in this specific environment).
...
4. **Export/import of the whole library** (not just per-archive export), for migrating between machines.
5. **Accessibility pass** on the trusted UI (keyboard navigation, screen reader labeling).
